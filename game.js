...
const generateGame1 =() =>{  
    ...
    const imagesWithDescriptions = [
        { emojis: '🥔', description: 'potato' },
        { emojis:  '🍒', description: 'cherry' },
        { emojis: '🥑', description: 'avocado' },
        { emojis:  '🌽', description: 'corn' },
        { emojis: '🥕', description: 'carrot' },
        { emojis: '🍇', description: 'grape' },
        { emojis: '🍉', description: 'watermelon' },
        { emojis: '🍌', description: 'banana' },
        { emojis: '🥭', description: 'mango' },
        { emojis:  '🍍', description: 'pineapple' }
    ];
    if (dimensions % 2 !== 0) {
        throw new Error("The dimension of the board must be an even number.")
    }
